...
exports.signup = function(req, res, next) {
    ...
    if (!req.user) {
        ...
        user.save((err) => {
            ...
            console.log("it seems like new user was created");
...
// create a  method named create(), which will be used to create new users
...
exports.update = function(req, res, next) {
    User.findByIdAndUpdate(req.user.id, req.params, {
        'new': true
    }, (err, user) => {
        if (err) {
            return next(err);
